...
void CAgent::save_q(std::vector<float> subspace, char *file_name)
{
  float x, y;

  u32 i;
  u32 actions_count = agent_init.actions.size();
  CLog log(file_name, 4 + actions_count);
