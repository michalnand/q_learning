...
void compare_all_results(u32 map_id)
{
	...
	char function_6_file_name[1024];
	...
	sprintf(function_6_file_name,"%s/map_%u/function_type_6/summary_error_results.log", S_RESULTS_PATH, map_id);
	...
	functions.push_back(new CLogRead(function_6_file_name));
