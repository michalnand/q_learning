...
\runningheads{M. Chovanec, L. Čechovič}{Function aproximation using experimental artifical neuron model}
...
\corraddr{michal.chovanec@fri.uniza.sk, lukas.cechovic@fri.uniza.sk}
...
\keywords{neural network, approximation, neuron model, McCulloch-Pitts neuron}
